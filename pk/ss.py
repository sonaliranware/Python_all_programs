...
for q in range(8):
  ...
  if (useranswer==answer[rnum]):
    ...
    print("Press any key to continue to the next question")
    input()
    replit.clear()
  else :
